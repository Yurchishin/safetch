...
type _ = [
  ...
  Test<
    ExpectType<
      ValidateOptionalCatchAllPathPatternSegment<"[[...param]]">,
      "[[...param]]"
    >
  >,
  Test<
    ExpectType<ValidateOptionalCatchAllPathPatternSegment<"[...param]">, never>
  >,
  // Type check tests for PickOptionalCatchAllPathPatternParamNameSegment
  Test<
    ExpectType<
      PickOptionalCatchAllPathPatternParamNameSegment<"[[...param]]">,
      "param"
    >
  >,
  Test<
  ...
  Test<
    ExpectType<
      ValidateOptionalCatchAllPathPatternSegments<"[[...param]]">,
      "[[...param]]"
    >
  >,
  Test<
    ExpectType<ValidateOptionalCatchAllPathPatternSegments<"[...param]">, never>
  >,
  Test<
    ExpectType<
      ValidateOptionalCatchAllPathPatternSegments<"[[...param]]/[[...param2]]">,
      never
    >
  >,
  Test<
...
describe("OptionalCatchAll", () => {
  it("should succeed creating instance with a valid path pattern segment", () => {
    ...
    expect(segment.paramSchema).toEqual({
      testParam: expect.any(z.ZodDefault),
    });
  ...
  it("should throw an error creating instance with an invalid path pattern segment", () => {
    ...
    expect(() => new OptionalCatchAll("[[...testParam]]/test")).toThrow(
