...
export type ValidateSingleParamPathPatternSegment<P extends string> =
...
export type ValidateSingleParamPathPatternSegments<P extends string> =
...
export const pathPatternSingleParamSegmentRegex = /^\[(?<param>.+)]$/;

class SingleParamPathPatternSegment extends ParamPathPatternSegment<
